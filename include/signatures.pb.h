...
typedef PB_BYTES_ARRAY_T(16) Signatures_AES_GCM_Personalized_Signature_Data_epoch_t;
typedef PB_BYTES_ARRAY_T(12) Signatures_AES_GCM_Personalized_Signature_Data_nonce_t;
typedef PB_BYTES_ARRAY_T(16) Signatures_AES_GCM_Personalized_Signature_Data_tag_t;
typedef struct _Signatures_AES_GCM_Personalized_Signature_Data {
    Signatures_AES_GCM_Personalized_Signature_Data_epoch_t epoch;
    Signatures_AES_GCM_Personalized_Signature_Data_nonce_t nonce;
    uint32_t counter;
    uint32_t expires_at;
    Signatures_AES_GCM_Personalized_Signature_Data_tag_t tag;
...
typedef PB_BYTES_ARRAY_T(32) Signatures_HMAC_Signature_Data_tag_t;
typedef struct _Signatures_HMAC_Signature_Data {
    Signatures_HMAC_Signature_Data_tag_t tag;
} Signatures_HMAC_Signature_Data;

typedef PB_BYTES_ARRAY_T(16) Signatures_HMAC_Personalized_Signature_Data_epoch_t;
typedef PB_BYTES_ARRAY_T(32) Signatures_HMAC_Personalized_Signature_Data_tag_t;
typedef struct _Signatures_HMAC_Personalized_Signature_Data {
    Signatures_HMAC_Personalized_Signature_Data_epoch_t epoch;
    uint32_t counter;
    uint32_t expires_at;
...
X(a, STATIC,   SINGULAR, BYTES,    tag,               4)
...
#define Signatures_HMAC_Personalized_Signature_Data_size 63
#define Signatures_HMAC_Signature_Data_size      34
#define Signatures_KeyIdentity_size              67
#define Signatures_SessionInfo_size              104
#define Signatures_SignatureData_size            134
