...
typedef PB_BYTES_ARRAY_T(1024) UniversalMessage_RoutableMessage_protobuf_message_as_bytes_t;
typedef PB_BYTES_ARRAY_T(200) UniversalMessage_RoutableMessage_session_info_t;
